...
public class DateToolsTest {
    ...
    public void testFormatters() {
        ...
        String result = DateTools.dateUnderlineBlankTimeColon(dateTime);
        Assert.assertEquals("", "2020-12-12 12:12:12", result);

        dateTime = LocalDateTime.of(2020, 12, 12, 12, 12, 0, 0);
        result = DateTools.dateUnderlineBlankTimeColon(dateTime);
        ...
        result = DateTools.dateUnderlineBlankTimeColon(date);
        ...
        result = DateTools.dateUnderlineBlankTimeColon(time);
